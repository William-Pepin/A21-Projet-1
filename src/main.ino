...
void loop()
{
  ...
  while(1)
  {
    ColorCapteurRawData(&Couleurs);
    ColorCapteurKelvin(&Couleurs);
    delay(1000);
    ...
    Serial.print("\n");
    if((Couleurs.Kelvin > 11000) & (abs(Couleurs.Red - Couleurs.Blue) > 500))
    {
      Serial.print("Bleu");
      Serial.print("\n");
    }
    else if((Couleurs.Kelvin > 11000) & (abs(Couleurs.Red - Couleurs.Blue) < 500))
    {
      Serial.print("Rouge");
      Serial.print("\n");
    }
    else if((Couleurs.Kelvin < 7000) & (Couleurs.Kelvin > 5000))
    {
      Serial.print("Jaune");
      Serial.print("\n");
    }
    else if(( Couleurs.Kelvin < 11000) & (Couleurs.Kelvin > 7000))
    {
      Serial.print("Vert");
      Serial.print("\n");
    }
    else if(Couleurs.Kelvin )
    {
      Serial.print("Aucune Lecture");
      Serial.print("\n");
    }
